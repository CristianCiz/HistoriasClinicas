...
namespace TestHistoriasClinicas.Controllers
{
    public class EpisodiosController : Controller
    {
        ...
        public EpisodiosController(TestHistoriasClinicasContext context)
        {
            _context = context;
        }
        ...
        {
            var testHistoriasClinicasContext = _context.Episodios.Include(e => e.HistoriaClinica);
        ...
        {
            ViewData["HistoriaClinicaId"] = new SelectList(_context.Set<HistoriaClinica>(), "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Motivo,Descripcion,FechaYHoraInicio,FechaYHoraAlta,FechaYHoraCierre,EstadoAbierto,HistoriaClinicaId")] Episodio episodio)
        {
            ...
            ViewData["HistoriaClinicaId"] = new SelectList(_context.Set<HistoriaClinica>(), "Id", "Id", episodio.HistoriaClinicaId);
            return View(episodio);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Motivo,Descripcion,FechaYHoraInicio,FechaYHoraAlta,FechaYHoraCierre,EstadoAbierto,HistoriaClinicaId")] Episodio episodio)
        {
            if (id != episodio.Id)
            {
                return NotFound();
