...
namespace TestHistoriasClinicas.Controllers
{
    public class EspecialidadesController : Controller
    {
        ...
        public EspecialidadesController(TestHistoriasClinicasContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,TituloEspecialidad")] Especialidad especialidad)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TituloEspecialidad")] Especialidad especialidad)
        {
